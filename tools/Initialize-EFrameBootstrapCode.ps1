...
namespace $RootNamespace.UI.Views
{
    public sealed class HomeView : BindingViewBase
    {
        ...
        public static string DefaultAssetPath => ResPath.App.UI.Panel("HomeView");
    }
}
"@
...
namespace $RootNamespace.UI.Controllers
{
    public sealed class HomeViewController : UIControllerBase<HomeView>
    {
        ...
        protected override string AssetPath => ResPath.App.UI.Panel("HomeView");
...
2. Create the module's main view prefab under `Assets/Modules/$ModuleName/Res/UI` and add a `QUIBinding` root.
3. Add module scenes under `Assets/Modules/$ModuleName/Scenes` if this module owns scene content.
4. Keep module-only resources inside this directory; only move shared content back to `Assets/App/...` when it is truly common.
"@
...
namespace $moduleNamespace.Common
{
    ...
    {
        public static string MainView => ResPath.Modules.Asset("$ModuleName", "Res/UI/${ModuleName}MainView");
...
- `Assets/App/Res/UI/Panels/HomeView.prefab` (copied from the package template in Unity Editor)
...
- `Assets/Modules/SampleModule/Res/UI/SampleModuleMainView.prefab` (copied from the package template in Unity Editor)

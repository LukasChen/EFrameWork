...
- 修改 `.github/copilot-instructions.md`、`.github/managed-blocks/**`、`.github/instructions/**`、`.github/skills/**` 或 `.github/eframe-ai.manifest.json`
...
3. 业务项目根 instruction 和本地 AI 规则归项目自己所有；框架同步只能更新 EFrame managed block 和 `eframe-*` 文件。
...
5. manifest、release check、commit 和 tag 要求以 `EFRAME_AI_RELEASE_CHECKLIST.md` 为准。

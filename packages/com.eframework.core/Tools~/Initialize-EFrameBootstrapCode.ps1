...
$AppNamespace = 'GameApp'
$GeneratedNamespace = 'EFramework.Generated'
...
namespace $AppNamespace.Procedure
{
...
using EFramework.Runtime.Procedure;
using $AppNamespace.Modules.SampleModule.Procedure;
using $AppNamespace.UI.Controllers;
using UnityEngine;
...
namespace $AppNamespace.UI.Views
{
...
using System;
using EFramework.Generated;
using $AppNamespace.UI.Views;
using EFramework.Runtime.UI;

namespace $AppNamespace.UI.Controllers
{
...
function New-ModuleScaffold {
    ...
    $moduleNamespace = "$AppNamespace.Modules.$ModuleName"
...
5. Set the entrance procedure type name to $AppNamespace.Procedure.ProcedureLauncher
...
Write-TemplateFile -Path (Join-Path $resolvedTargetRoot "Assets/App/Runtime/Generated/Res/ResPath.Generated.cs") -Content $resPathGeneratedContent -Overwrite:$Force
...
Write-Host "EFrame bootstrap code scaffold complete. Generated code namespace: $GeneratedNamespace"

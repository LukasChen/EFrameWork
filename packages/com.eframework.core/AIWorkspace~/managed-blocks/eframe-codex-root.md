...
- Route UI through `EFrame.UI` / `IUIService`, `UIControllerBase`, `UIViewHandle`, and the default `QUI` service; do not hand-build persistent top-level runtime Canvas or EventSystem objects.

...
7. Treat View wrappers as generated access classes: keep reusable business state outside generated View classes, and access runtime views from controllers through `CurrentView`.
8. Reference UI prefabs through generated `ResPath.Generated` ids; do not scatter prefab address strings or add handwritten path wrappers.

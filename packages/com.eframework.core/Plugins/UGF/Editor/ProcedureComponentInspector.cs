...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class ProcedureComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                if (m_CurrentAvailableProcedureTypeNames.Count > 0)
                {
                    ...
                    GUIStyle orangeBackgroundStyle = new(GUI.skin.box);
                    orangeBackgroundStyle.normal.background = EditorGUIUtility.whiteTexture;
                    orangeBackgroundStyle.normal.textColor = Color.black;
                    orangeBackgroundStyle.margin = new RectOffset(0, 0, 5, 5);
                    orangeBackgroundStyle.padding = new RectOffset(10, 10, 10, 10);

                    Color originalColor = GUI.backgroundColor;
                    GUI.backgroundColor = new Color(1f, 0.64f, 0f); // 橙色
        ...
        private string[] GetProcedureTypeNames()
        {

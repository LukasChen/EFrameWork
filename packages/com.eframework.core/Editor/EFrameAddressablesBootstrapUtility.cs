...
namespace EFrameWork.Editor.ProjectBootstrap
{
    internal static class EFrameAddressablesBootstrapUtility
    {
        ...
        internal const string LegacyAppLocalGroupName = "App Local Group";
        ...
        private static bool SyncManagedAssets(out string message)
        {
            ...
            RemoveLegacyGroupIfEmpty(settings, LegacyAppLocalGroupName);
            AssetDatabase.SaveAssets();
        ...
        private static void RemoveLegacyGroupIfEmpty(AddressableAssetSettings settings, string groupName)
        {
            var group = settings.FindGroup(groupName);

...
This file belongs to this project. Keep project-specific AI rules outside the EFrame managed block; EFrame sync only updates the marked block below.

<!-- BEGIN EFRAME AI MANAGED BLOCK: eframework-claude-root -->
...
<!-- END EFRAME AI MANAGED BLOCK: eframework-claude-root -->
